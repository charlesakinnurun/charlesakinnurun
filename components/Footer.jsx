...
const socialLinks = [
  { name: 'GitHub', icon: Github, url: 'https://github.com/charlesakinnurun' },
  { name: 'LinkedIn', icon: Linkedin, url: 'https://www.linkedin.com/in/charlesakinnurun' },
  //{ name: 'Twitter', icon: Twitter, url: 'http://x.com/junaiddshaukat' },
  { name: 'Email', icon: Mail, url: 'mailto:charlesakinnurun@gmail.com' },
]
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          <div className="text-center sm:text-left">
            <h2 className="text-lg font-semibold text-white">Charles</h2>
            <p className="text-sm text-white">Machine Learning Engineer</p>
          </div>
        ...
        <div className="mt-4 pt-4 border-t border-[#312f2f] text-center">
          <p className="text-xs text-white">
            © {new Date().getFullYear()} Charles Akinnurun. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
