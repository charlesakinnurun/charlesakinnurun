    ...
    <div className="bg-[#242424] rounded-3xl p-6 shadow-lg">
      ...
      <div className="flex justify-center gap-4">
        <SocialIcon
          ...
          label="LinkedIn"
          url="https://www.linkedin.com/in/charlesakinnurun/"
        />
        <SocialIcon
          icon={<Github className="w-5 h-5" />}
          label="Github"
          url="https://github.com/charlesakinnurun"
        />
        <SocialIcon
          icon={<Mail className="w-5 h-5" />}
          label="Email"
          url="mailto:charlesakinnurun@gmail.com"
        />
        {/*<}SocialIcon
...
function MainContent() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-4">Machine Learning Engineer</h1>
...
{/* 
  <a href="https://github.com/Junaid-Shaukat">
    ...
    />
      ...
      <a 
          href="https://drive.google.com/file/d/10hh3x-R_xUjcrNS2kl09FQC7O7gD50G6/view?usp=sharing"
          target='_blank' 
          download="charlesakinnurun.pdf"
