...
I'm an Applied Data Scientist, AI/ML Engineer, and <!--AI/ML Scholar at [AWS](https://github.com/aws)-->Quantitative Analyst that specializes in machine & deep learning, generative AI, NLP, computer vision, and MLOps. I bring hands-on experience in data science, analytics, and quantitative and statistical modeling, working extensively with tools like PyTorch, Scikit-learn, and AWS to deliver impactful solutions.
